...
const services = [
    {
        ...
        desc: "Every pixel serves a purpose. We create visuals that align with your business goals and resonate with your audience.",
        icon: "◆",
    },
    {
        num: "02",
        title: "Web Development",
        desc: "Blazing-fast, accessible, and beautiful. Built with modern frameworks and clean architecture.",
        icon: "⬡",
    },
    {
        num: "03",
        title: "Brand Identity",
        desc: "Memorable identities that tell your story. From logo to full brand systems that scale.",
        icon: "◎",
    },
    {
        num: "04",
        title: "Motion & 3D",
        desc: "Immersive animations and interactive experiences that captivate and differentiate.",
        icon: "△",
    },
];
                    ...
                    {services.map((s, i) => (
                        ...
                        >
                            <TiltCard className="group rounded-2xl border border-white/5 bg-white/[0.02] p-8 md:p-10 h-full cursor-pointer">
                                ...
                                <p className="text-white/30 text-sm leading-relaxed font-geist">
                                    {s.desc}
                                </p>
                                <div className="mt-6 flex items-center gap-2 text-white/20 group-hover:text-emerald-400 transition-colors">
                                    <span className="text-xs font-geist-mono uppercase tracking-wider">Learn more</span>
